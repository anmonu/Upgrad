...
plot_grid(ggplot(employee_master, aes(x=BusinessTravel,fill=Attrition))+ geom_bar()+bar_theme1, 
          ggplot(employee_master, aes(x=Department,fill=Attrition))+ geom_bar()+bar_theme1,
          ggplot(employee_master, aes(x=EducationField,fill=Attrition))+ geom_bar()+bar_theme1,
          ggplot(employee_master, aes(x=Gender,fill=Attrition))+ geom_bar()+bar_theme1,
          ggplot(employee_master, aes(x=JobRole,fill=Attrition))+ geom_bar()+bar_theme1,
          ggplot(employee_master, aes(x=MaritalStatus,fill=Attrition))+ geom_bar()+bar_theme1,
          align = "h")   
...
plot_grid(ggplot(employee_master, aes(Education))+ geom_histogram(binwidth = 1),
          ggplot(employee_master, aes(x="",y=Education))+ geom_boxplot(width=0.1)+coord_flip()+box_theme, 
          align = "v",ncol = 1)

plot_grid(ggplot(employee_master, aes(PercentSalaryHike))+ geom_histogram(binwidth = 0.5),
          ggplot(employee_master, aes(x="",y=PercentSalaryHike))+ geom_boxplot(width=0.1)+coord_flip()+box_theme, 
          align = "v",ncol = 1)

plot_grid(ggplot(employee_master, aes(Average_office_hours))+ geom_histogram(),
          ggplot(employee_master, aes(x="",y=Average_office_hours))+ geom_boxplot(width=0.1)+coord_flip()+box_theme, 
          align = "v",ncol = 1) 


plot_grid(ggplot(employee_master, aes(Leaves_taken))+ geom_histogram(),
          ggplot(employee_master, aes(x="",y=Leaves_taken))+ geom_boxplot(width=0.1)+coord_flip()+box_theme, 
          align = "v",ncol = 1) 


# Boxplots of numeric variables relative to employee_master status
plot_grid(ggplot(employee_master, aes(x=Attrition,y=Leaves_taken, fill=Attrition))+ geom_boxplot(width=0.2)+ 
            coord_flip() +theme(legend.position="none"),
          ggplot(employee_master, aes(x=Attrition,y=Average_office_hours, fill=Attrition))+ geom_boxplot(width=0.2)+
            coord_flip() + box_theme_y,
          ggplot(employee_master, aes(x=Attrition,y=JobSatisfaction, fill=Attrition))+ geom_boxplot(width=0.2)+
            coord_flip() + box_theme_y,
          ggplot(employee_master, aes(x=Attrition,y=JobInvolvement, fill=Attrition))+ geom_boxplot(width=0.2)+
            coord_flip() + box_theme_y,
...
library(GGally)
ggpairs(employee_master[, c("JobSatisfaction", "Average_office_hours")])



plot_grid(ggplot(employee_master, aes(x=Attrition,y=JobSatisfaction, fill=Attrition))+ geom_boxplot(width=0.2)+ 
            coord_flip() +theme(legend.position="none"),
          ggplot(employee_master, aes(x=Attrition,y=JobInvolvement, fill=Attrition))+ geom_boxplot(width=0.2)+
            coord_flip() + box_theme_y,
          ggplot(employee_master, aes(x=Attrition,y=WorkLifeBalance, fill=Attrition))+ geom_boxplot(width=0.2)+
            coord_flip() + box_theme_y,
          ggplot(employee_master, aes(x=Attrition,y=EnvironmentSatisfaction, fill=Attrition))+ geom_boxplot(width=0.2)+
            coord_flip() + box_theme_y,
          align = "v",nrow = 1)

plot_grid(ggplot(employee_master, aes(x=Attrition,y=YearsWithCurrManager, fill=Attrition))+ geom_boxplot(width=0.2)+
            coord_flip() +theme(legend.position="none"),
          ...
          ggplot(employee_master, aes(x=Attrition,y=TotalWorkingYears, fill=Attrition))+ geom_boxplot(width=0.2)+
            coord_flip() + box_theme_y,
          ggplot(employee_master, aes(x=Attrition,y=TrainingTimesLastYear, fill=Attrition))+ geom_boxplot(width=0.2)+
            coord_flip() + box_theme_y,
          align = "v",nrow = 1)
...
levels(employee_master$Attrition) <- c(0,1) # No for 1 and 0 for yes
...
#All variables are having *** now.
vif(model_19) #All are in 1-3 range
